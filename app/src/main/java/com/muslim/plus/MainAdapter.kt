...
import com.muslim.plus.api.DataItem
import com.muslim.plus.databinding.ItemSuratBinding
import com.muslim.plus.page.PageSurahActivity
import java.util.*
    ...
    inner class MainViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(dataItem: DataItem) {
            ...
            binding.cvItem.setOnClickListener {
                val intent = Intent(activity, PageSurahActivity::class.java).apply {
                    putExtra(PageSurahActivity.EXTRA_NO_PAGE, dataItem.number)
                }
